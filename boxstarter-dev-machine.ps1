...
try {
  ...
  Install-ChocolateyVsixPackage "Add New File" "https://visualstudiogallery.msdn.microsoft.com/3f820e99-6c0d-41db-aa74-a18d9623b1f3/file/140782/13/AddAnyFile.vsix"
